-- Visionox VTDR6130 OLED used by the Retroid Pocket 6 and the Visionox
-- variants of the Retroid Pocket 5 and Flip2. It exposes no EDID, so gamescope
...
gamescope.config.known_displays.armada_retroid_vtdr6130_oled = {
    ...
    matches = function(display)
        if (display.device_id == "retroid-pocket-6"
            or display.device_id == "retroid-pocket-5-visionox"
            or display.device_id == "retroid-pocket-flip2-visionox")
